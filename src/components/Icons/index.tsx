...
const IconDownload = ({ height = 24, width = 24, className = "" }: Props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height={height} width={width} className={clsx("h-4 md:h-4.5 fill-current", className)}>
...
const IconFolderPlus = ({ height = 24, width = 24, className = "" }: Props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height={height} width={width} className={clsx("h-4 md:h-4.5 fill-current", className)}>
...
const IconFolder = ({ height = 24, width = 24, className = "" }: Props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height={height} width={width} className={clsx("h-3.5 fill-current", className)}>
...
const IconFolderOpen = ({ height = 24, width = 24, className = "" }: Props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" height={height} width={width} className={clsx("h-3.5 fill-current", className)}>
...
const IconChevronRight = ({ height = 24, width = 24, className = "" }: Props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" height={height} width={width} className={clsx("h-3 fill-current", className)}>
      <path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z" />
    </svg>
  );
};

export { IconChevronRight, IconDocument, IconDownload, IconEyeOpen, IconEyeSlash, IconFileArrowDown, IconFilePen, IconFloppyDisk, IconFolder, IconFolderOpen, IconFolderPlus, IconMenu, IconPlus, IconRotate, IconTrash, IconXMark };
